...
?>
	...
	<div class="row">
		...
		<div class="col-lg-offset-2 col-lg-6">
			<form class="form-signin"style="background-color: white;padding:25px;border-radius:5px"method="post" action="">
				<label for="name">Name</label>
				<input type="text" value="<?php echo $member_name;?>" name="name" placeholder="Name" id="name" class="form-control" require><br>
				<!-- <label for="rollno">RollNo</label>
				<input type="text" value="<?php echo $rollno;?>" name="rollno" placeholder="rollno" id="rollno" class="form-control" require><br> -->
				...
				<?php if($role == 'President'|| $role == 'President')
				{
					...
					<select class="form-control" name="role">
	    				...
	    				<option name="Member" value="Member">Member</option>
					   	...
					   	<option name="Member Management" value="Senior">Senior</option>
